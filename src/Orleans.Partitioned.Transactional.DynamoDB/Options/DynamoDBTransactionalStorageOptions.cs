...
namespace Orleans.Configuration
{
    public class DynamoDBTransactionalStorageOptions : DynamoDBClientOptions, IStorageProviderSerializerOptions
    {
        ...
        /// </summary>
        public int ReadCapacityUnits { get; set; } = TransactionalDynamoDBStorage.DefaultReadCapacityUnits;

        /// <summary>
        /// Write capacity unit for DynamoDB storage
        /// </summary>
        public int WriteCapacityUnits { get; set; } = TransactionalDynamoDBStorage.DefaultWriteCapacityUnits;
